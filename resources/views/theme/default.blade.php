                        ...
                        {{csrf_field()}}
                          ...
                          <div class="modal-footer">
                            ...
                            @if (env('Environment') == 'sendbox')
                                <input type="button" class="btn btn-outline-primary btn-lg" onclick="myFunction()" value="Update">
                            @else
                      ...
                      <div class="modal-dialog modal-notify modal-info" role="document">
                          ...
                          <div class="modal-content text-center">
                              ...
                              <div class="modal-footer flex-center">
                                  <a role="button" class="btn btn-outline-secondary-modal waves-effect" data-dismiss="modal" onClick="window.location.reload();">Ok</a>
                              </div>
                          </div>
                          <!--/.Content-->
                      </div>
