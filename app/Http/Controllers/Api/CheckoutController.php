...
class CheckoutController extends Controller
{
    ...
    public function wallet(Request $request)
    {
        ...
        $transaction_data=Transaction::select('order_number','transaction_type','wallet',DB::raw('DATE_FORMAT(created_at, "%Y-%m-%d") as date'),'username')->where('user_id',$request->user_id)->orderBy('id', 'DESC')->get();
