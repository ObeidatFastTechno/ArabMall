...
class HomeController extends Controller
{
    ...
    {
        $payload = file_get_contents('http://gravityinfotech.net/api/getdata.php?envato_username='.$request->envato_username.'&email='.$request->email.'&purchase_key='.$request->purchase_key.'&domain='.$request->domain.'');
